...
void Filter_Pa(uint8_t PaStatus)
{
    switch(PaStatus)
    {
        case 0:
            ...
            u8g2_DrawStr(&u8g2, 7, 51, "Filter:");
            u8g2_DrawStr(&u8g2, 107, 51, "Pa");
            u8g2_SetFont(&u8g2, u8g2_font_5x7_tr );
            u8g2_DrawStr(&u8g2, 78, 51, "999");//Variable
...
void Flow(uint8_t FlowStatus)
{
    switch (FlowStatus)
    {
        case 0:
            ...
            u8g2_DrawStr(&u8g2, 7, 61, "Flow  :");
            u8g2_SetFont(&u8g2, u8g2_font_5x7_mf);
            u8g2_DrawStr(&u8g2, 107, 61, "m/s");
            u8g2_SetFont(&u8g2, u8g2_font_5x7_tr);
            u8g2_DrawStr(&u8g2, 77, 61, "00");//Variable
            u8g2_DrawStr(&u8g2, 87, 61, ".");
            u8g2_DrawStr(&u8g2, 91, 61, "99");//Variable
            break;
        case 1:
            break;
        default:
