...
/* Pin definitions */
#define HD44780_RS_LOW              TM_GPIO_SetPinLow(HD44780_RS_GPIO_Port, HD44780_RS_Pin)
#define HD44780_RS_HIGH             TM_GPIO_SetPinHigh(HD44780_RS_GPIO_Port, HD44780_RS_Pin)
#define HD44780_E_LOW               TM_GPIO_SetPinLow(HD44780_E_GPIO_Port, HD44780_E_Pin)
#define HD44780_E_HIGH              TM_GPIO_SetPinHigh(HD44780_E_GPIO_Port, HD44780_E_Pin)
...
static void D44780_Cmd(uint8_t cmd);
...
void HD44780_Puts(uint8_t x, uint8_t y, char* str) {
	...
	while (*str) {
		...
		if (*str == '\n') {
			HD44780_Opts.currentY++;
			D44780_CursorSet(HD44780_Opts.currentX, HD44780_Opts.currentY);
		} else if (*str == '\r') {
